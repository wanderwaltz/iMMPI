...
@property (weak, nonatomic) id<StatementTableViewCellDelegate> _Nullable delegate;


/// Label which is used to display the ID of the statement
@property (strong, nonatomic) IBOutlet UILabel * _Nullable statementIDLabel;


/// Label which is used to display the text of the statement
@property (strong, nonatomic) IBOutlet UILabel * _Nullable statementTextLabel;


/// Label which is used to display the user provided answer (positive/negative) to the statement in textual form
@property (strong, nonatomic) IBOutlet UILabel * _Nullable statementAnswerLabel;
...
@property (strong, nonatomic) IBOutlet UISegmentedControl * _Nullable statementSegmentedControl;
