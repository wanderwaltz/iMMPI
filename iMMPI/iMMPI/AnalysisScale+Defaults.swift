...
extension AnalysisScale {
    ...
    ///
    /// Шкала 2 - депрессии (D) - отражает степень пессимизма и неудовлетворенности.
    ///
    ...
    /// действительности.
    ///
    /// Идеализированный портрет истерика: здоровье слабое - боли в сердце и груди, иногда жар,
    /// мышечные судороги, ощущение комка в горле, обмороки, ухудшение зрения, гудение или звон в
    /// ушах, дрожание рук, частые головные боли; само чувствие плохое - общая усталость, подавленное
    /// настроение, плохой аппетит, тошноты, характер независимый, тревожный, мнительный; отношение
    /// к жизни безразличное до негативного; отношение к людям - общительность, внимание, доброта,
    /// доверие, конформность. Психотерапия помогает, но временно.
    ///
    /// Собчик Л. Н. Стандартизированный многофакторный метод исследования личности
    /// СМИЛ. – СПб.: Речь, 2000. – 219 с.
