...
public struct RecordsListViewControllerStyle {
    fileprivate init(
        updateCell: @escaping (UITableViewCell, RecordsGroup) -> (),
...
extension RecordsListViewControllerStyle {
    public static let root = RecordsListViewControllerStyle(
    ...
    public static func nested(basedOn record: RecordProtocol) -> RecordsListViewControllerStyle {
