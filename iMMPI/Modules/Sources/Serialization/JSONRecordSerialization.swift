...
public final class JSONRecordSerialization {
    let version = "1.0"
    ...
    public init(
        person: JSONPersonSerialization = JSONPersonSerialization(),
...
extension JSONRecordSerialization {
    public func encode(_ record: RecordProtocol) -> Data? {
    ...
    public func decode(_ data: Data?) -> Record? {
        guard let data = data,
