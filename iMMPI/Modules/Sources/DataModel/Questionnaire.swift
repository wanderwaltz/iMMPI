...
public struct Questionnaire {
    ...
    private let statementsById: [Statement.Identifier:Statement]

    private init(statements: [Statement]) {
...
extension Questionnaire {
    public var statementsCount: Int { statements.count }
    ...
    public func statement(id: Statement.Identifier) -> Statement? {
...
extension Questionnaire {
    ...
    public init(record: RecordProtocol) throws {
...
private let questionnaireFilePathExtension = "json"
...
private let questionnaireFileNames: [Gender:[AgeGroup:String]] = [
    .male: [
