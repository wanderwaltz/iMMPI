...
extension AnalysisScale {
    ...
    public static let f = AnalysisScale(
        identifier: .f,
    ...
    /// Язвительность
    static let vitriol = AnalysisScale(
        identifier: .vitriol,
        title: NSLocalizedString("Язвительность", comment: "Название шкалы"),
        index: .common(144),
        score: .median(
            .specific(male: 49.6, female: 43.3),
            dispersion: .specific(male: 5.47, female: 6.22),
            basedOn: .raw(
                positive: [28, 37, 58, 79, 98, 137, 133, 152, 207, 223, 235, 240, 253, 258, 262, 264, 283, 310, 378, 380, 423, 426, 460, 493, 521, 563],
    ...
    // MARK: Конформизм (конверсионная реакция)

    /// Конформизм (конверсионная реакция)
    static let conformism = AnalysisScale(
        identifier: .conformism,
        title: NSLocalizedString("Конформизм (конверсионная реакция)", comment: "Название шкалы"),
        index: .common(150),
        score: .median(
            .specific(male: 54.75, female: 47.57),
            dispersion: .specific(male: 7.74, female: 7.63),
            basedOn: .raw(
                positive: [8, 20, 37, 58, 70, 79, 95, 96, 112, 131, 133, 137, 152, 170, 223, 249, 262, 264, 329, 369, 399, 403, 407, 440, 445, 490],
                negative: [4, 5, 13, 21, 24, 34, 42, 61, 67, 76, 106, 139, 146, 179, 180, 189, 204, 234, 236, 243, 247, 266, 282, 284, 299, 301, 305, 337, 344, 349, 352, 357, 359, 360, 382, 388, 397, 411, 425, 431, 454, 455, 487, 489, 494, 499, 503, 510, 517, 531, 543]
            )
        ))
    ...
    /// Авторитет
    static let authority = AnalysisScale(
        identifier: .authority,
        title: NSLocalizedString("Авторитет", comment: "Название шкалы"),
        index: .common(151),
        score: .brackets(
            .specific(
                male: (41, 48, 64, 70),
            ...
            basedOn: .rawPercentage(
                positive: [141, 221, 235, 377, 509, 552, 564],
                negative: [91, 132, 143, 208, 287, 340, 359, 382, 386, 409, 425, 435, 481, 482, 501, 511, 520, 558, 562]
            )
        ))
    ...
    /// Успех женский
    static let female_success = AnalysisScale(
        identifier: .female_success,
        title: NSLocalizedString("Успех женский", comment: "Название шкалы"),
        index: .common(152),
        score: .brackets(
            (41, 47, 60, 64),
            basedOn: .rawPercentage(
                positive: [69, 96, 111, 132, 138, 158, 166, 198, 227, 230, 261, 297, 340, 378, 385, 394, 402, 492, 533, 562],
    ...
    // MARK: Социальные потребности

    /// Социальные потребности
    static let social_needs = AnalysisScale(
        identifier: .social_needs,
        title: NSLocalizedString("Социальные потребности", comment: "Название шкалы"),
        index: .common(159),
        score: .median(
            .specific(male: 66.87, female: 60.67),
            dispersion: .specific(male: 6.74, female: 7.14),
            basedOn: .raw(
                positive: [7, 17, 18, 54, 65, 83, 107, 113, 163, 164, 169, 185, 190, 196, 220, 242, 257, 272, 371, 528],
                negative: [14, 27, 32, 34, 35, 40, 42, 43, 48, 49, 50, 66, 85, 121, 123, 125, 138, 139, 148, 151, 156, 158, 168, 171, 184, 186, 197, 200, 202, 205, 209, 210, 211, 218, 241, 245, 246, 247, 252, 256, 263, 267, 269, 275, 286, 288, 291, 293, 301, 321, 335, 337, 352, 383, 424, 431, 439, 549, 555]
            )
        ))


    // MARK: Потребительская тенденция

    /// Потребительская тенденция
    static let consumer_tendency = AnalysisScale(
        identifier: .consumer_tendency,
        title: NSLocalizedString("Потребительская тенденция", comment: "Название шкалы"),
        index: .common(160),
        score: .brackets(
            (30, 36, 56, 64),
            basedOn: .rawPercentage(
                positive: [28, 39, 40, 41, 45, 80, 86, 93, 101, 110, 120, 142, 172, 186, 191, 231, 238, 262, 278, 292, 304, 316, 321, 336, 345, 351, 352, 355, 357, 359, 361, 374, 382, 389, 416, 418, 442, 458, 487, 499, 500, 505, 531],
    ...
    /// Гипнабельность
    static let hypnability = AnalysisScale(
        identifier: .hypnability,
        title: NSLocalizedString("Гипнабельность", comment: "Название шкалы"),
        index: .common(165),
        score: .rawPercentage(
            positive: [10, 11, 13, 22, 27, 40, 41, 47, 50, 53, 62, 72, 77, 82, 86, 97, 101, 110, 114, 115, 126, 127, 139, 141, 149, 156, 158, 161, 186, 191, 194, 201, 213, 215, 227, 237, 236, 246, 248, 249, 251, 273, 284, 286, 291, 299, 305, 321, 323, 332, 339, 340, 341, 345, 357, 377, 394, 400, 413, 420, 425, 433, 466, 476, 483, 499, 506, 511, 530, 541, 543, 545, 564, 565],
            negative: []
        ))
}
