...
import MMPIRouting
import MMPIDatePickerUI

public protocol EditRecordViewControllerDelegate: AnyObject {
    func editRecordViewController(
        _ controller: EditRecordViewController,
...
public final class EditRecordViewController: UITableViewController, UsingRouting {
    public weak var delegate: EditRecordViewControllerDelegate?
...
extension EditRecordViewController: DatePickerControllerDateDelegate {
    public func datePickerController(
        _ datePickerController: DatePickerController,
        didSelect date: Date
    ) {
        selectedDate = date
        reloadData()
