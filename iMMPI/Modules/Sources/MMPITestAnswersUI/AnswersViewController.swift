...
public class AnswersViewController: UIViewController, UsingRouting {
    public weak var inputDelegate: AnswersInputDelegate?

    public var cellSource = StatementTableViewCell.makeSourceForReview()

    @IBOutlet public var tableView: UITableView?

    public var viewModel: AnswersViewModel? {
        didSet {
