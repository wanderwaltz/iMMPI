...
public protocol AnalysisOptionsViewControllerDelegate: AnyObject {
    func analysisOptionsViewControllerSettingsChanged(_ controller: AnalysisOptionsViewController)
}

public final class AnalysisOptionsViewController: UITableViewController, UsingRouting {
    public weak var delegate: AnalysisOptionsViewControllerDelegate?

    public var viewModel: AnalysisOptionsViewModel? {
        willSet {
